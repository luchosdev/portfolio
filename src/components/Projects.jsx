...
const Projects = () => {
    return (
        <section className="" id="projects">
            <h1 className="pt-14 mb-3 text-blue_1 text-3xl font-extrabold font-poppins">Projects</h1>

            <div className="bg-white rounded-md border mx-4 mt-4 pb-4 px-2" id="project-1">
                <picture className="flex justify-center">
                    <img className="w-80" src={Admin_ECommerce} alt="admin-ecommerce" />
                </picture>
                <h3 className="text-orange_1 text-2xl font-bold font-poppins mb-2">Admin E-commerce</h3>
                ...
                <article className="text-xl font-poppins text-black text-justify mx-4">
            ...
            <div className="bg-white rounded-md border mx-4 mt-4 pb-4 px-2" id="project-2">
                <picture className="flex justify-center">
                    <img className="w-80" src={YardSales} alt="yardsales" />
                </picture>
                <h3 className="text-orange_1 text-2xl font-bold font-poppins mb-2">Yard Sales E-commerce</h3>
                <p className="text-xl text-black font-poppins mb-5">
            ...
            <div className="bg-white rounded-md border mx-4 mt-4 pb-4 px-2" id="project-3">
                <picture className="flex justify-center">
                    <img className="w-80" src={GoogleClone} alt="" />
                </picture>
                <h3 className="text-orange_1 text-2xl font-bold font-poppins mb-2">Google Clone</h3>
                <p className="text-xl text-black font-poppins mb-5">
            ...
            <div className="bg-white rounded-md border mx-4 mt-4 pb-4 px-2" id="project-4">
                <picture className="flex justify-center">
                    <img className="w-80" src={LandingPage} alt="" />
                </picture>
                <h3 className="text-orange_1 text-2xl font-bold font-poppins mb-2">Sign in Landing Page</h3>
                <p className="text-xl text-black font-poppins mb-5">
